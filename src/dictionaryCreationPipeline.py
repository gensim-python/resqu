...
DICTDIR = os.path.join(DATADIR,"abstracts_without_GS.dict")
print DICTDIR
...
def get_pmids_for_concept(concept):
    text


def get_text_as_list(pmid):
    text



# Step 2
summary = ["Migraine Disorders","Diabetes","Myocardial Infarction"]
